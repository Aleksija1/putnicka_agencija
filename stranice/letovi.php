...
<html lang="en">
   ...
   <body>
      ...
      <nav class="navbar navbar-expand-lg  bg-light navbar-light">
         <div class="container">
            <a class="navbar-brand" href="http://localhost/putnicka_agencija/stranice/stranica.php"
               id="logo">DESTINIKA
            </a>
            <button
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
               <ul class="navbar-nav ms-auto align-items-center">
                  <li class="nav-item">
                     <a class="nav-link mx-2" href="http://localhost/putnicka_agencija/stranice/letovi.php"><i class="fas fa-bell pe-2"></i>Letovi</a>
                  </li>
                  <li class="nav-item">
                     <a class="nav-link mx-2" href="http://localhost/putnicka_agencija/stranice/O_nama.php"><i class="fas fa-heart pe-2"></i>O nama</a>
                  </li>
                  <li class="nav-item">
                     <a class="nav-link mx-2" href="http://localhost/putnicka_agencija/stranice/kontakt.php"><i class="fas fa-bell pe-2"></i>Kontakt</a>
                  </li>
                  <li class="nav-item ms-3">
                     <?php 
                        ...
                        if(isset($_SESSION["ime"])){
                          ...
                          ?>
                     <a class="btn btn-black btn-rounded"href="http://localhost/putnicka_agencija/prijava/login.php#!" >Log in</a>
                     <?php
                        }
                        ?>
                  </li>
                  <?php 
                     if(isset($_SESSION["ime"])){
                       ?>
                  <li class="nav-item">
                     <a class="nav-link mx-2" href="http://localhost/putnicka_agencija/php/odjava.php"><i class="fas fa-bell pe-2"></i>Odjava</a>
                  </li>
                  <?php
                     }
                     ?>
                     ...
                     <tr>
                        ...
                        <?php 
                           if(isset($_SESSION["ime"])){
                             ?>
                        <td> 
                           <a href='http://localhost/putnicka_agencija/stranice/rezervacije.php?let=<?php echo $row["id_leta"]?>'>
      ...
      <footer class="bg-body-tertiary text-center fixed-bottom">
         ...
         <div class="text-center p-3" style="background-color:#FFFFFF;">
            © 2024 Copyright:
            <a class="text-body" href="http://localhost/putnicka_agencija/stranice/stranica.php">Destinika.com</a>
         </div>
      </footer>
